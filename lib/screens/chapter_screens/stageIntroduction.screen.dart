...
class StageIntroductionScreen extends StatelessWidget {
  ...
  _stageBody(Size size) {
    ...
    return Container(
      ...
      margin: EdgeInsets.only(left: bodyMarginLeft,top: bodyMarginTop),
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            //   border: Border.all(color: Colors.white)
            // ),
            child: Text('Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolo remque laudantium, totam rem aperiam',
            style: korolevFont.headline4?.apply(
            fontSizeFactor: size.height * 0.00068, fontWeightDelta: 2),textAlign: TextAlign.left,)
          ...
          Container(
            ...
            //   border: Border.all(color: Colors.white)
            // ),
            child: Text('Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione',
            style: korolevFont.bodyText1?.apply(
            fontSizeFactor: size.height * 0.0012, fontWeightDelta: 0),textAlign: TextAlign.left,)
          ),
          SizedBox(height: spacedBodyContainers),
          Container(
          ...
          Container(
            ...
            //   border: Border.all(color: Colors.white)
            // ),
            child: Text('Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora',
