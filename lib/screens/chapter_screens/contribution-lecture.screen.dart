...
class ContributionLectureScreen extends StatefulWidget {
  static const String route = '/contribution_lecture';
  
  

  @override
  _ContributionLectureScreenState createState() => _ContributionLectureScreenState();
}

class _ContributionLectureScreenState extends State<ContributionLectureScreen> {
  TeamDto? teamDto;
        ...
        children: [
          ...
          Padding(
            ...
            child: ContributionContenMarkdown(
              teamContent: 'LECTURA SOBRE LA CIUDAD',
            ),
          ),
          Padding(
            padding: EdgeInsets.symmetric(
            ...
            child: Text(
               'EXPLICACIÓN ACERCA DE LA RECOMENDACIÓN DE LECTURA SOBRE LA CIUDAD',
